        ...
        withReplyEvent:(NSAppleEventDescriptor*)replyEvent
{
    ...
    if ([url hasPrefix:AUTOMATOR_URL_PREFIX]) {
        ...
        [self.statusTextField setStringValue:NSLocalizedString(@"Running AppleScript", nil)];
        
        NSString *source = [[url stringByReplacingCharactersInRange:NSMakeRange(0, APPLESCRIPT_URL_PREFIX.length)
